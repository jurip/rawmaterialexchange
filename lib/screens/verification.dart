                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                              ...
                              child:
                            Text('verification'.tr(), style: kTextStyle1),
                            ),
                          ],
                        ),
                        ...
                        SizedBox(height: 24.0),
                        Text('you_will_receive_SMS_to_number'.tr(), style: kTextStyle6),
                        SizedBox(height: 6.0),
                        ...
                        Row(
                          ...
                          children: [
                            _start > 0 ?
                            Text('no_sms_coming'.tr() + ' ' + _start.toString(), style: kTextStyle8) :
                                InkWell(
                                  onTap: () {
                                    if (widget.name == null) {
                                      getAuthorization(widget.phone).then((data) {
                                        ...
                                        if (data != null) {
                                          if (data.smsSended != null /* && data.sms_sended! */ && data.smsCode != null) {
                                      ...
                                      getRegistration(
                                          ...
                                          widget.phone,
                                          widget.dateBirthday!,
                                          widget.selectedLanguageId!).then((
                                          data) {
                                        _sendingMsgProgressBar?.hide();
                                        if (data != null) {
                                          if (data.sms_sended !=
                                            ...
                                            if (data.errors != null &&
                                              ...
                                              String toastMessage = data.errors!
                                                  .first;
                                    ...
                                    child: Text('send_again'.tr(), style: kTextStyle8),
                                ),
                          ],
                        ),
