...
class _LocationInfoWidgetState extends State<LocationInfoWidget> {
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: kColorGrey1,
                                border:
                                    Border.all(color: kColorGrey1, width: 3),
                                      ...
                                      PopupMenuItem(
                                        child: Container(
                                          ...
                                          child: ListView.builder(
                                            shrinkWrap: true,
                                            itemCount: locationInfo
                                                .workingHours.length,
                                            itemBuilder: (context, index) {
                                              return Text(
                                                '${getDayString(locationInfo.workingHours[index].day).tr()}: ${getStartEnd(locationInfo.workingHours[index].start, locationInfo.workingHours[index].end)}',
                                                softWrap: false,
                                                style: kBottomSheetTextStyle,
                                              );
                                            },
                            ...
                            Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  _openSite(
                                      locationInfo.listObjectData.website);
                                },
                                child: Image(
                                    height: 30,
  ...
  String getCurrentDate() {
    ...
    if (index == -1) {
      return getDayString(locationInfo.workingHours[0].day).tr() +
          ': ' +
          getStartEnd(locationInfo.workingHours[0].start,
              locationInfo.workingHours[0].end);
    }
    return getDayString(locationInfo.workingHours[index].day).tr() +
        ': ' +
