...
class BottomSheet extends StatefulWidget {
  ...
  /// a custom [shape] and the content can extend past this shape. For app,
    ...
    final Widget bottomSheet = MediaQuery.removePadding(
      ...
      child: Builder(
        builder: (BuildContext context) {
          final BottomSheetThemeData sheetTheme = Theme
              .of(context)
              .bottomSheetTheme;
          return _ModalBottomSheet<T>(
            ...
            elevation: elevation ?? sheetTheme.modalElevation ??
...
///
/// For app, if [startingPoint] is set to `0.5`, and [curve] is set to
...
///
/// This app demonstrates how to use `showModalBottomSheet` to display a
